...
If you are running the Azure Stack Monthly Update Verification workflow and the version of your OEM update package is not 1810 or higher, you will receive an error once you get to the OEM update step. This is a bug. The mitigation steps are as follows:

1.	Run the OEM update as normal
2.	Execute Test-AzureStack after successful application of the package and save the output
3.	Cancel the test.
4.  Send the saved output to VaaSHelp@microsoft.com to recieve a 'provisional' passing results.
